...
void Regole() 
{
	...
	cout << "9. Il simbolo 'X' sono le celle colpite; ']' sono le celle vuote; 'O' sono le navi affondate\n\n";
}
...
int main() {
	...
	while (naviAffondate != 10)
	{
		...
		else if (campo[lettere][numeri] != '@' && campo[lettere][numeri] != '#' && campo[lettere][numeri] != 'X' && campo[lettere][numeri] != 'O')
		{
			cout << "La cella " << lettereTentativo << numeri + 1 << " non ha navi\n\n";
			campo[lettere][numeri] = 'X';
			punteggio++;
